...
function preload() {
  ...
  kaboom = loadSound("assets/cannon_explosion.mp3");
  splash = loadSound("assets/cannon_water.mp3");
  yarr = loadSound("assets/pirare_laugh.mp3");
  music = loadSound("assets/piratasdocaribe.mp3");
}
